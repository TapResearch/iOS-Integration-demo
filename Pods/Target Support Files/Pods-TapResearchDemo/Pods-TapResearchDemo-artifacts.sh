...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/TapResearch/TapResearchSDK.xcframework" "" "true" "ios-arm64_i386_x86_64-simulator/TapResearchSDK.framework" "ios-arm64_armv7/TapResearchSDK.framework"
fi
